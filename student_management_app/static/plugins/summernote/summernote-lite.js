...
(function (global, factory) {
  ...
  var videoDialog = function (opt) {
      var body = '<div class="note-form-group">' +
          ...
          '</label>' +
          '<input class="note-video-url note-input" onkeydown="return /[a-z]/i.test(event.key)" />' +
          '</div>';
      var footer = [
  ...
  var imageDialog = function (opt) {
      var body = '<div class="note-form-group note-group-select-from-files">' +
          ...
          '<input class="note-image-url note-input" onkeydown="return /[a-z]/i.test(event.key)" />' +
          '</div>';
      var footer = [
  ...
  var linkDialog = function (opt) {
      var body = '<div class="note-form-group">' +
          ...
          '<input class="note-link-text note-input" onkeydown="return /[a-z]/i.test(event.key)" />' +
          '</div>' +
          '<div class="note-form-group">' +
          '<label class="note-form-label">' + opt.lang.link.url + '</label>' +
          '<input class="note-link-url note-input" onkeydown="return /[a-z]/i.test(event.key)" value="http://" />' +
          '</div>' +
  ...
  var LinkDialog = /** @class */ (function () {
      ...
      LinkDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              '<input class="note-link-text form-control note-form-control note-input" onkeydown="return /[a-z]/i.test(event.key)" />',
              '</div>',
              '<div class="form-group note-form-group">',
              "<label class=\"note-form-label\">" + this.lang.link.url + "</label>",
              '<input class="note-link-url form-control note-form-control note-input" onkeydown="return /[a-z]/i.test(event.key)" value="http://" />',
              '</div>',
  ...
  var ImageDialog = /** @class */ (function () {
      ...
      ImageDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              ' col-md-12" onkeydown="return /[a-z]/i.test(event.key)" />',
              '</div>',
          ].join('');
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              '<input class="note-video-url form-control note-form-control note-input" onkeydown="return /[a-z]/i.test(event.key)" />',
              '</div>',
          ].join('');
