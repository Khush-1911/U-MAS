...
urlpatterns = [
    ...
    path('edit_institution/<int:institution_id>',OwnerViews.edit_institution,name="edit_institution"),
    path('edit_institution_save',OwnerViews.edit_institution_save,name="edit_institution_save"),
    ...
    path('edit_user/<int:user_id>',OwnerViews.edit_user,name="edit_user"),
    path('edit_user_save',OwnerViews.edit_user_save,name="edit_user_save"),
    path('superuser_home',SuperuserViews.superuser_home,name="superuser_home"),
    path('superuser_manage_users',SuperuserViews.superuser_manage_users,name="superuser_manage_users"),
    path('superuser_edit_user/<int:user_id>',SuperuserViews.superuser_edit_user,name="superuser_edit_user"),
    path('superuser_edit_user_save',SuperuserViews.superuser_edit_user_save,name="superuser_edit_user_save"),
    ...
    path('principal_edit_user/<int:user_id>',PrincipalViews.principal_edit_user,name="principal_edit_user"),
    path('principal_edit_user_save',PrincipalViews.principal_edit_user_save,name="principal_edit_user_save"),
